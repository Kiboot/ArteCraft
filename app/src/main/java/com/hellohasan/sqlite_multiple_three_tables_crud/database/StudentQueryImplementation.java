...
public class StudentQueryImplementation implements QueryContract.StudentQuery {
    ...
    public void createStudent(Student student, QueryResponse<Boolean> response) {
        ...
        try {
            ...
            if(id>0) {
                ...
                response.onFailure("Failed to create sale. Unknown Reason!");
    ...
    public void readStudent(int studentId, QueryResponse<Student> response) {
        ...
        try {
            ...
            if(cursor!=null && cursor.moveToFirst()) {
                ...
                response.onFailure("Sale not found with this ID in database");
    ...
    public void readAllStudent(QueryResponse<List<Student>> response) {
        ...
        try {
            ...
            if(cursor!=null && cursor.moveToFirst()){
                ...
                response.onFailure("There are no sales in the database");
    ...
    public void updateStudent(Student student, QueryResponse<Boolean> response) {
        ...
        ContentValues contentValues = getContentValuesForStudentSHORT(student);
        ...
        try {
            ...
            if(rowCount>0)
                ...
                response.onFailure(contentValues.toString());
        } catch (Exception e){
            response.onFailure(e.getMessage());
        } finally {
            sqLiteDatabase.close();
    ...
    public void deleteStudent(int studentId, QueryResponse<Boolean> response) {
        ...
        try {
            ...
            if(rowCount>0)
                ...
                response.onFailure("Failed to delete sale. Unknown reason");
        } catch (Exception e){
            response.onFailure(e.getMessage());
        } finally {
            sqLiteDatabase.close();
    ...
    private ContentValues getContentValuesForStudentSHORT(Student student){
        ContentValues contentValues = new ContentValues();
    ...
    private Student getStudentFromCursor(Cursor cursor){
        ...
        String regNum = cursor.getString(cursor.getColumnIndex(STUDENT_REGISTRATION_NUM));
